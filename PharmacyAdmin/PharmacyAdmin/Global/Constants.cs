...
namespace Global
{
    ...
    public enum RelativeDateSubType
    {
        DAY = 0,
        WEEK = 1,
        BIWEEK = 2,
    ...
    public class Constants
    {
        ...
        public static readonly string ViewDocumentRoute = "Document";
        public static readonly string DownloadDocumentRoute = "api/download";
        ...
        // Error Messages
        public static readonly string ERROR_DOCUMENT_SERVICE_READ_FILE_TO_BYTES = "Could not read file to byte array";
        public static readonly string ERROR_DOCUMENT_SERVICE_READ_FILE_TO_MEMORY = "Could not read file to memory stream";

        // Date Constants
        public static readonly string LAST_WEEK_FROM_TODAY = "LAST_WEEK";
        public static readonly string LAST_BIWEEK_FROM_TODAY = "LAST_BIWEEK";
        public static readonly string LAST_MONTH_FROM_TODAY = "LAST_MONTH";
        public static readonly string CURRENT_WEEK_FROM_TODAY = "CURRENT_WEEK";
        public static readonly string CURRENT_MONTH_FROM_TODAY = "CURRENT_MONTH";
        public static readonly string CURRENT_YEAR_FROM_TODAY = "CURRENT_YEAR";

        // ErrorCodes
        public static readonly string ERROR_STORAGE_DOWNLOAD_DIRECTORY_MISSING = "Download Directory is missing";

        public static readonly string ERROR_LOG_REPOSITORY = "ErrorLogRepository";
        public static readonly string CPRSQL_DISPENSE_REPOSITORY = "CPRSQLDispenseRepository";
        public static readonly string CPRSQL_DOCUMENT_SERVICE = "CPRSQLDocumentService";
        public static readonly string CPRSQL_DOCUMENT_WORKER = "CPRSQLDocumentWorker";
        public static readonly string CPRSQL_SCHEDULE_SERVICE = "CPRSQLScheduleService";

        public static readonly string CPRSQL_VW_CUBE_TICKET_TICKET_CONFIRMATION_DATE_COLUMN = "ticket_confirmation_date_timestamp";

        public static readonly string PIONEERRX_DISPENSE_DATE_COLUMN = "DateFilled";
